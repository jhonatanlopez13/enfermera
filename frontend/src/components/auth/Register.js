...
const Register = () => {
  const [formData, setFormData] = useState({
    ...
    usuario: '',
    nombre: '',
    apellido: '',        // Nuevo campo requerido
    email: '',           // Nuevo campo requerido
    telefono: '',
    direccion: '',
    fecha_nacimiento: '',
    genero: '',
  ...
  const validateForm = () => {
    ...
    // Validar nombre (ahora separado en nombre y apellido)
    if (!formData.nombre.trim()) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Enviar todos los campos requeridos por la tabla
      const response = await authService.register({
                    ...
                    <div className="col-12 mt-3">
                      <div className="alert alert-info">
                        ...
                        <ul className="mb-0 mt-2">
                          ...
                          <li>Por defecto se asignará el rol de <strong>RECEPCIONISTA</strong></li>
                          <li>Los roles de ADMIN y ENFERMERA deben ser asignados por un administrador</li>
                          <li>Los datos serán verificados por el personal administrativo</li>
                        </ul>
                      </div>
                    </div>
